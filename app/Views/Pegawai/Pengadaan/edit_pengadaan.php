        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header">
                    <a href="/Pegawai/detailPengadaan/<?= $pengadaan['id_pengadaan_barang'] ?>">&laquo; Kembali ke detail
                        pengadaan
                        barang</a>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('/Pegawai/updatePengadaan/' . $pengadaan['id']) ?>" method="post"
