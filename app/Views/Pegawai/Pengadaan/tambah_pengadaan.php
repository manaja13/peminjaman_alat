...
<div class="container-fluid">
    ...
    <form action="<?= base_url('/Pegawai/simpanPengadaan') ?> " method="post" enctype="multipart/form-data" id="form">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="/Pegawai/pengadaan">&laquo; Kembali ke daftar pengadaan barang</a>
                            </div>
