<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center"
        ...
        <img src="<?php echo base_url() ?>/assets/img/11.png" width="75px"
            height="75px">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item"
                    href="<?php echo base_url('Admin/masterBarang'); ?>">Master
                    Barang </a>
                <a class="collapse-item"
                    href="<?php echo base_url('Admin/satuan'); ?>">Master
                    Satuan</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="barang" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item"
                    href="<?php echo base_url('Admin/permintaan_masuk'); ?>">Peminjaman alat</a>
                <a class="collapse-item"
                    href="<?php echo base_url('Admin/permintaan_proses'); ?>">Peminjaman alat Diproses</a>
                <a class="collapse-item"
                    href="<?php echo base_url('Admin/permintaan_selesai'); ?>">Peminjaman alat Selesai</a>
            </div>
        </div>
    </li>
