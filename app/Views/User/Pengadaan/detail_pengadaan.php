        ...
        <div class="col-lg-8">
            <div class="card shadow p-3">
                <div class="row col-lg-12 mx-2 mb-3">
                    <!-- tombol cetak kanan -->
                    <div class="col-lg-12">
                        <a href="/Pegawai/cetakPengadaan/<?= $detail['pengadaan_barang_id']; ?>" target="_blank" class="btn btn-primary btn-icon-split float-right">
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Pegawai/detailPengadaanBarang/<?= $data['id'] ?>" class="  btn btn-primary"><i class="fas fa-eye"></i></a>

                                            <?php if ($data['status'] == 'belum diproses') { ?>

                                                <a href="/Pegawai/editPengadaan/<?= $data['id'] ?>" class="  btn btn-success"><i class="fa fa-edit"></i> </a>
                ...
                <br>
                <a href="/Pegawai/pengadaan" class="btn btn-secondary">&laquo; Kembali ke daftar Pengadaan barang
                </a>
            </div>
        </div>
    </div>
