        ...
        <div class="col-lg-8">
            <div class="card shadow p-3">
                <div class="row col-lg-12 mx-2 mb-3">
                    <!-- tombol cetak kanan -->
                    <div class="col-lg-12">
                        <a href="/Petugas_pengadaan/cetakPengadaan/<?= $detail['pengadaan_barang_id']; ?>" target="_blank" class="btn btn-primary btn-icon-split float-right">
                ...
                <div class="row col-lg-12 mx-2 table-responsive">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Petugas_pengadaan/detailPengadaan/<?= $data['id'] ?>" class="btn btn-primary"><i class="fas fa-eye""></i> </a>
                            ...
                            <tr>
                                <td colspan=" 3" style="text-align: center;">Data tidak ditemukan
                                        </td>
                                    </tr>
                                <?php } ?>
                        </tbody>
                ...
                <br>
                <a href="<?= base_url('Petugas_pengadaan/pengadaan'); ?>" class="btn btn-secondary">&laquo; Kembali ke
                    daftar Pengadaan
                    barang
                </a>
            </div>
